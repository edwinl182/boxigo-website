		...
		<div class="row">
			<div class="col-sm-3 border-right">
				...
				<ul class="nav nav-pills mb-3 justify-content-center d-block" id="pills-tab" role="tablist">
					...
					<li class="nav-item mt-4 mb-5 nav_item_with_badge">
						<a class="nav-link rounded" id="pills-other-tab" data-toggle="pill" href="#pills-other" role="tab" aria-controls="pills-other" aria-selected="false">Other <span data-indv-value="0" class="data-indv-count other_item_count badge badge-warning"></span></a>
					</li>
				</ul>
		 								...
		 								<div class="form-group mx-2 text-center">
											<div class="input-group">
												<div class="input-group-prepend">
													<span class="input-group-text pointer btn-number1 bg-success text-white" disabled="disabled" data-type="minus" data-field="<?= $k; ?>">-</span>
												</div>
												...
												<div class="input-group-append">
													<span class="input-group-text pointer btn-number1 bg-success text-white" data-type="plus" data-field="<?= $k; ?>">+</span>
												</div>
											</div>
